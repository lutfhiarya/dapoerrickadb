...
<head>
    ...
    <!-- logo icon link -->
    <link rel="icon" type="image/png" sizes="32x32" href=<?= base_url('assets/_ref/img/logodapur.png'); ?>>
    <!-- js respon -->
    <script>
    function respon() {
...
<body>
    ...
    <header class="header">
        <div class="logoContent">
            <a href="<?= base_url(); ?>" class="logo"><img src="<?= base_url('assets/_ref/img/logodapur.png'); ?>"></a>
            <h1 class="logoName">Dapoer Ricka</h1>
        </div>
        ...
        <nav class="navbar">
            ...
            <a href="<?= base_url('pages/about'); ?>">AboutUs</a>
